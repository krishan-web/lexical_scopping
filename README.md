...
Submit by May 2, 12:29 PM IST
i
 
It looks like this is your first peer-graded assignment.  Learn more

Submit your assignment soon
Even though your assignment is due on May 2, 12:29 PM IST, try to submit it 1 or 2 days early if you can. Submitting early gives you a better chance of getting the peer reviews you need in time.
Coursera Lab Sandbox
BETA
Easily launch Coursera's preconfigured environment for R programming
Get access to all dependencies (libraries and packages) for RStudio—no local software installation required
Practice R programming, run test cases, and work on assignments from your browser
